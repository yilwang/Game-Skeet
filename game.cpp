 ...
 : topLeft(tl), bottomRight(br), rifle(br)
{
   ...
   this->bird = NULL;// I am changing the address of the bird pointer to null.
   // In this way, we can go to draw and check if bird is null or not! If it is null, then don't draw!
}
...
void Game :: draw(const Interface & ui)
{
 ...
 if(score >= 0)
 {
   ...
   // Put the text of score on the screen
 ...
 {
      Point scoreTextLocation;
      scoreTextLocation.setX(topLeft.getX() + 400);
      scoreTextLocation.setY(topLeft.getY() - 400);
      drawText(scoreTextLocation, "Game Over");
 }
}
